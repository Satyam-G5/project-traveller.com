    ...
    return (
        <div className=' bg-white mt-8 p-4 text-center'>
            ...
            <div className='bg-white flex flex-row'>
                <div className="p-20 flex max-h-screen h-90 flex-col items-center justify-center mt-2">
                ...
                <div className="p-20 flex min-w-screen w-2/3 max-h-screen h-90 flex-col justify-center ">
                        ...
                        <div className="text-left px-6 py-4">
                            {travel.map((item) => (
                                <div className='' key={item._id}>
                                    ...
                                    <div className='flex flex-row p-1 justify-between'><p className='font-bold text-green-700'>Contact Info : </p> <p className='text-black'>{item.email}</p></div>
